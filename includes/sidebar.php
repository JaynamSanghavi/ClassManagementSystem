...
<div class="left side-menu">
	...
	<div class="slimscroll-menu" id="remove-scroll">
		...
		<div class="user-box">
			...
			<p class="text-muted"><?php echo strtoupper($_SESSION['member_role']); ?></p>
		</div>
		...
		<div id="sidebar-menu">
			...
			<li>
					<a href="javascript: void(0);"><i class="fi-layers"></i> <span> Branch &amp; Semester </span> <span class="menu-arrow"></span></a>
					<ul class="nav-second-level" aria-expanded="false">
						<li><a href="branch.php">Manage Branch</a></li>
						<li><a href="semester.php">Manage Semester</a></li>
						<li><a href="subjects.php">Manage Subject</a></li>
					</ul>
				</li>
