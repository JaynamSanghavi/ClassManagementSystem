<?php
        ...
        class Subjects extends GeneralFunction{
...
<tr>
    ...
    <td>
        <div class="button-list">
            <a type="button" class="btn btn-icon waves-effect waves-light btn-purple" data-toggle="tooltip" title="Edit Subject!" href="subjects.php?q=edit&id=<?php echo $id; ?>"> <i class="fa fa-pencil"></i> </a>
            
            <a type="button" class="btn btn-icon waves-effect waves-light btn-danger delete-subjects" data-toggle="tooltip" title="Delete Subjects!" data-record-id="<?php echo $id; ?>"> <i class="fa fa-remove"></i> </a>
        </div>
    </td>
</tr>
<?php
